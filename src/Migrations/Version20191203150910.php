 ...
 */
final class Version20191203150910 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE theses (id INT AUTO_INCREMENT NOT NULL, ecoles_id INT NOT NULL, title VARCHAR(255) NOT NULL, phrase VARCHAR(255) NOT NULL, contact VARCHAR(255) NOT NULL, INDEX IDX_3FABCA41D096F5D (ecoles_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
